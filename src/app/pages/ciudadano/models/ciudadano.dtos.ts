...
export interface DTOCiudadano {
  ...
  ci_estado: number;
  ci_fecha_registrada?: string | null;
}

export type DTOCiudadanoCreate = Pick<
  DTOCiudadano,
  'ci_DNI' |
  'ci_nombres' |
  'ci_apellido_p' |
...
export type DTOCiudadanoSoftDelete = Pick<DTOCiudadano, 'ci_ID'>;

export type DTOCiudadanoListaOptions =
  Partial<Pick<
    DTOCiudadano,
    'ci_ID' |
    'ci_DNI' |
